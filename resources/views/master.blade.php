...
<head>
    ...
    <title>DumacoDocs | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini">D<b>D+</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">Dumaco<b>DOCS+</b></span>
            </a>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('addCasefiles')}}"><i class="fa fa-plus"></i>Nuevo</a></li>
                            <li><a href="{{route('listCasefiles')}}"><i class="fa fa-file"></i>Listar</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('addUser')}}"><i class="fa fa-plus"></i>Nuevo</a></li>
                            <li><a href="{{route('listUser')}}"><i class="fa fa-file"></i>Listar</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019 <a target="_blank" href="https://www.dumaco.net/">Dumaco SAC</a>.</strong> All rights reserved.
        </footer>
