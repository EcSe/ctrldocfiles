...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a><i class="fa fa-plus"></i>Nuevo</a></li>
                            <li><a><i class="fa fa-file"></i>Listar</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2019 <a href="https://www.dumaco.net/">Dumaco SAC</a>.</strong> All rights reserved.
        </footer>
